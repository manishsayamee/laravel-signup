                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class ='form-group row'>
                            <div class ='col-md-6 offset-md-3'>
                                ...
                                <a href="{{ route('login.twitter') }}"  class = 'btn btn-dark btn-block'>Login with Twitter</a>
                                <a href="{{ route('login.linkedin') }}"  class = 'btn btn-primary btn-block'>Login with Linkedin</a>
